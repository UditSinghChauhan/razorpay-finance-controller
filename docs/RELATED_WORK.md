...
other formula, universe or threshold moved. `§1.4`'s positioning statement is untouched. Benchmark moves to
...
**At spec 1.4.29** this document is unchanged apart from the version header. See
`DECISION_BRIEF.md §A.36`.

**At spec 1.4.28** this document is unchanged apart from the version header. See
`DECISION_BRIEF.md §A.35`.

**At spec 1.4.27** this document is unchanged apart from the version header. See
`DECISION_BRIEF.md §A.34`.

**At spec 1.4.26** this document is unchanged apart from the version header. See
